...
urlfile="https://raw.github.com/FanWallentin/SEM-RCode/main/Examples-note4-Rcode/peerinfluences.csv"
...
semPaths(fit_A, whatLabels = "est",
         sizeMan = 2, edge.label.cex = 1,
         style = "ram",curvature =2,
         nCharNodes = 0, nCharEdges = 0,
         layout = "tree2",rotation = 2,asize = 0.5)
