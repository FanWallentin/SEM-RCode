...
library(lavaan)
library(semPlot)
urlfile="https://raw.github.com/FanWallentin/SEM-RCode/main/Examples-note4-Rcode/leader1.txt"
...
semPaths(fit2, whatLabels = "est",
         sizeMan = 5, edge.label.cex = 1, sizeLat = 5,
         style = "ram",rotation = 4,
         nCharNodes = 0, nCharEdges = 0,intercepts = FALSE,
         layout = "tree2",thresholds = F)
